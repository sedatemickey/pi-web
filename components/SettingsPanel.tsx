...
import { PiUiConfig } from "./PiUiConfig";
...
export function SettingsSectionIcon({ section, size = 16, strokeWidth = 1.8 }: { section: SettingsSection; size?: number; strokeWidth?: number }) {
  ...
  if (section === "pi-ui") return <svg {...common}><rect x="3" y="3" width="8" height="8" rx="1.5" /><rect x="13" y="3" width="8" height="5" rx="1.5" /><rect x="13" y="10" width="8" height="11" rx="1.5" /><rect x="3" y="13" width="8" height="8" rx="1.5" /></svg>;
...
export function SettingsPanel({ cwd, sessionId, initialSection, onClose, onSessionReloaded, quoteSelectionEnabled, onQuoteSelectionChange }: Props) {
  ...
  const sections: { id: SettingsSection; label: string; requiresProject: boolean }[] = [
    ...
    { id: "pi-ui", label: t("common.piUi"), requiresProject: false },
    ...
    >
      <div className="settings-dialog-surface">
        ...
        <main className="settings-dialog-main">
          ...
          {sectionHost("pi-ui", <PiUiConfig embedded sessionId={sessionId} onClose={onClose} onReloaded={onSessionReloaded} />)}
