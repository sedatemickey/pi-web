...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "piUi.title": "Pi UI",
    "piUi.subtitle": "宣告式回覆元件",
    "piUi.close": "關閉",
    "piUi.enabledTitle": "啟用 Pi UI",
    "piUi.enabledDescription": "向模型宣告此用戶端支援的宣告式回覆元件。",
    "piUi.reloadRequired": "重新載入目前工作階段以更新系統提示詞。",
    "piUi.reloadSession": "重新載入工作階段",
    "piUi.reloading": "正在重新載入...",
    "piUi.loading": "正在載入 Pi UI 設定...",
    "piUi.category.foundation": "基礎展示",
    "piUi.category.interactive": "互動內容",
    "piUi.category.charts": "圖表",
    "piUi.category.information": "狀態與資訊",
    "piUi.selectComponent": "開啟{name}設定",
    "piUi.componentToggle": "允許模型產生{name}",
    "piUi.protocolType": "協定類型",
    "piUi.fields": "欄位與限制",
    "piUi.preview": "預覽",
    "piUi.jsonExample": "JSON 範例",
    "piUi.error": "無法更新 Pi UI 設定：{message}",
    "piUi.promptOnlyNote": "這些開關只控制模型提示詞，既有卡片仍會正常呈現。",
    "piUi.component.metrics.name": "指標",
    "piUi.component.metrics.description": "精簡展示測量值與關鍵事實。",
    "piUi.component.comparison.name": "比較",
    "piUi.component.comparison.description": "並排比較二至四個選項。",
    "piUi.component.steps.name": "步驟",
    "piUi.component.steps.description": "展示有順序的流程、計畫或進度。",
    "piUi.component.tabs.name": "分頁標籤",
    "piUi.component.tabs.description": "以支援鍵盤操作的分頁展示相關並列資訊。",
    "piUi.component.accordion.name": "摺疊面板",
    "piUi.component.accordion.description": "依需要展開詳細資訊或分組結論。",
    "piUi.component.dataTable.name": "資料表格",
    "piUi.component.dataTable.description": "支援搜尋、排序及分頁的型別化記錄表格。",
    "piUi.component.barChart.name": "長條圖",
    "piUi.component.barChart.description": "比較一個或多個系列的分類數值。",
    "piUi.component.lineChart.name": "折線圖",
    "piUi.component.lineChart.description": "展示一個或多個系列隨有序標籤變化的趨勢。",
    "piUi.component.areaChart.name": "面積圖",
    "piUi.component.areaChart.description": "強調累計規模的數值趨勢。",
    "piUi.component.donutChart.name": "環圈圖",
    "piUi.component.donutChart.description": "以少量分區展示整體構成。",
    "piUi.component.sparkline.name": "迷你趨勢圖",
    "piUi.component.sparkline.description": "精簡展示單一資料系列的趨勢。",
    "piUi.component.heatmap.name": "熱圖",
    "piUi.component.heatmap.description": "依帶標籤的行列密集展示數值矩陣。",
    "piUi.component.status.name": "狀態",
    "piUi.component.status.description": "以語意色調展示單一目前狀態。",
    "piUi.component.keyValue.name": "鍵值資訊",
    "piUi.component.keyValue.description": "平鋪展示設定值或事實。",
    "piUi.component.progress.name": "進度",
    "piUi.component.progress.description": "展示已知工作的完成比例。",
    "piUi.component.checklist.name": "檢查清單",
    "piUi.component.checklist.description": "帶有明確完成狀態的簡短工作清單。",
    "piUi.component.callout.name": "提示框",
    "piUi.component.callout.description": "醒目展示簡短說明與可選要點。",
    "auth.prompt": "登入後繼續使用",
    "auth.password": "密碼",
    "auth.logIn": "登入",
    "auth.loggingIn": "正在登入...",
    ...
    "visual.card": "視覺化卡片",
    "visual.generating": "正在產生視覺化卡片",
    "visual.showSource": "原始碼",
    "visual.showCard": "卡片",
    "visual.error.incomplete": "這張視覺化卡片未產生完整。",
    "visual.error.tooMany": "這則訊息包含過多視覺化卡片。",
    "visual.error.tooLarge": "這張視覺化卡片內容過大。",
    "visual.error.tooDeep": "這張視覺化卡片巢狀層級過深。",
    "visual.error.invalidJson": "這張視覺化卡片包含無效 JSON。",
    "visual.error.invalidSchema": "這張視覺化卡片不符合支援的格式。",
    "visual.error.render": "無法繪製這張視覺化卡片。",
    "visual.status.complete": "已完成",
    "visual.status.current": "進行中",
    "visual.status.pending": "待處理",
    "visual.chart.category": "類別",
    "visual.chart.value": "數值",
    "visual.chart.point": "資料點",
    "visual.copyReadable": "複製可讀文字",
    "visual.accordion.search": "搜尋分組",
    "visual.accordion.expandAll": "全部展開",
    "visual.accordion.collapseAll": "全部摺疊",
    "visual.accordion.noMatches": "沒有符合的分組。",
    "visual.accordion.status.neutral": "資訊",
    "visual.accordion.status.success": "通過",
    "visual.accordion.status.warning": "警告",
    "visual.accordion.status.error": "錯誤",
    "visual.table.search": "搜尋表格",
    "visual.table.filterBy": "依{column}篩選",
    "visual.table.allStatuses": "全部狀態",
    "visual.table.copy": "複製表格",
    "visual.table.copied": "已複製",
    "visual.table.copyFailed": "無法複製表格。",
    "visual.table.downloadCsv": "下載 CSV",
    "visual.table.noMatches": "沒有符合的資料列。",
    "visual.table.range": "第 {start}-{end} 列，共 {total} 列",
    "visual.table.pagination": "表格分頁",
    "visual.table.previous": "上一頁",
    "visual.table.next": "下一頁",
    "visual.table.page": "第 {page}/{pages} 頁",
    "visual.table.status.neutral": "一般",
    "visual.table.status.success": "成功",
    "visual.table.status.warning": "警告",
    "visual.table.status.error": "錯誤",
    "i18n.zoomOut": "縮小",
    "i18n.zoomIn": "放大",
