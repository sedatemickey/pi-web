...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "piUi.title": "Pi UI",
    "piUi.subtitle": "Declarative response components",
    "piUi.close": "Close",
    "piUi.enabledTitle": "Enable Pi UI",
    "piUi.enabledDescription": "Tell models which declarative response components this client supports.",
    "piUi.reloadRequired": "Reload the current session to update its system prompt.",
    "piUi.reloadSession": "Reload session",
    "piUi.reloading": "Reloading...",
    "piUi.loading": "Loading Pi UI settings...",
    "piUi.category.foundation": "Core presentation",
    "piUi.category.interactive": "Interactive content",
    "piUi.category.charts": "Charts",
    "piUi.category.information": "Status and information",
    "piUi.selectComponent": "Open {name} settings",
    "piUi.componentToggle": "Allow models to generate {name}",
    "piUi.protocolType": "Protocol type",
    "piUi.fields": "Fields and limits",
    "piUi.preview": "Preview",
    "piUi.jsonExample": "JSON example",
    "piUi.error": "Could not update Pi UI settings: {message}",
    "piUi.promptOnlyNote": "These switches control model prompting only. Existing cards continue to render.",
    "piUi.component.metrics.name": "Metrics",
    "piUi.component.metrics.description": "Compact measured values and key facts.",
    "piUi.component.comparison.name": "Comparison",
    "piUi.component.comparison.description": "Side-by-side evaluation of two to four choices.",
    "piUi.component.steps.name": "Steps",
    "piUi.component.steps.description": "An ordered process, plan, or progress sequence.",
    "piUi.component.tabs.name": "Tabs",
    "piUi.component.tabs.description": "Keyboard-accessible parallel views of related information.",
    "piUi.component.accordion.name": "Accordion",
    "piUi.component.accordion.description": "Expandable groups for optional details or findings.",
    "piUi.component.dataTable.name": "Data table",
    "piUi.component.dataTable.description": "A searchable, sortable, paginated table of typed records.",
    "piUi.component.barChart.name": "Bar chart",
    "piUi.component.barChart.description": "Categorical values compared across one or more series.",
    "piUi.component.lineChart.name": "Line chart",
    "piUi.component.lineChart.description": "One or more trends across ordered labels.",
    "piUi.component.areaChart.name": "Area chart",
    "piUi.component.areaChart.description": "Magnitude trends with emphasis on cumulative volume.",
    "piUi.component.donutChart.name": "Donut chart",
    "piUi.component.donutChart.description": "A part-to-whole split with a small number of slices.",
    "piUi.component.sparkline.name": "Sparkline",
    "piUi.component.sparkline.description": "A compact trend for a single series.",
    "piUi.component.heatmap.name": "Heatmap",
    "piUi.component.heatmap.description": "A dense matrix of values across labelled rows and columns.",
    "piUi.component.status.name": "Status",
    "piUi.component.status.description": "A single current condition with a semantic tone.",
    "piUi.component.keyValue.name": "Key-value",
    "piUi.component.keyValue.description": "A flat list of labelled configuration values or facts.",
    "piUi.component.progress.name": "Progress",
    "piUi.component.progress.description": "Completion meters for known work.",
    "piUi.component.checklist.name": "Checklist",
    "piUi.component.checklist.description": "A short task list with explicit completion states.",
    "piUi.component.callout.name": "Callout",
    "piUi.component.callout.description": "A short emphasized note with optional supporting points.",
    ...
    "visual.generating": "Generating visual card",
    "visual.showSource": "Source",
    "visual.showCard": "Card",
    "visual.error.incomplete": "This visual card was not completed.",
    "visual.error.tooMany": "This message contains too many visual cards.",
    "visual.error.tooLarge": "This visual card is too large.",
    "visual.error.tooDeep": "This visual card is nested too deeply.",
    "visual.error.invalidJson": "This visual card contains invalid JSON.",
    "visual.error.invalidSchema": "This visual card does not match the supported format.",
    "visual.error.render": "The visual card could not be rendered.",
    "visual.status.complete": "Complete",
    "visual.status.current": "Current",
    "visual.status.pending": "Pending",
    "visual.chart.category": "Category",
    "visual.chart.value": "Value",
    "visual.chart.point": "Point",
    "visual.copyReadable": "Copy readable text",
    "visual.accordion.search": "Search sections",
    "visual.accordion.expandAll": "Expand all",
    "visual.accordion.collapseAll": "Collapse all",
    "visual.accordion.noMatches": "No matching sections.",
    "visual.accordion.status.neutral": "Info",
    "visual.accordion.status.success": "Passed",
    "visual.accordion.status.warning": "Warning",
    "visual.accordion.status.error": "Error",
    "visual.table.search": "Search table",
    "visual.table.filterBy": "Filter by {column}",
    "visual.table.allStatuses": "All statuses",
    "visual.table.copy": "Copy table",
    "visual.table.copied": "Copied",
    "visual.table.copyFailed": "Could not copy the table.",
    "visual.table.downloadCsv": "Download CSV",
    "visual.table.noMatches": "No matching rows.",
    "visual.table.range": "Rows {start}-{end} of {total}",
    "visual.table.pagination": "Table pages",
    "visual.table.previous": "Previous",
    "visual.table.next": "Next",
    "visual.table.page": "Page {page} of {pages}",
    "visual.table.status.neutral": "Neutral",
    "visual.table.status.success": "Success",
    "visual.table.status.warning": "Warning",
    "visual.table.status.error": "Error",
