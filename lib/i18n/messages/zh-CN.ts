...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "piUi.title": "Pi UI",
    "piUi.subtitle": "声明式回复组件",
    "piUi.close": "关闭",
    "piUi.enabledTitle": "启用 Pi UI",
    "piUi.enabledDescription": "向模型声明此客户端支持的声明式回复组件。",
    "piUi.reloadRequired": "重新加载当前会话以更新系统提示词。",
    "piUi.reloadSession": "重新加载会话",
    "piUi.reloading": "正在重新加载...",
    "piUi.loading": "正在加载 Pi UI 设置...",
    "piUi.category.foundation": "基础展示",
    "piUi.category.interactive": "交互内容",
    "piUi.category.charts": "图表",
    "piUi.category.information": "状态与信息",
    "piUi.selectComponent": "打开{name}设置",
    "piUi.componentToggle": "允许模型生成{name}",
    "piUi.protocolType": "协议类型",
    "piUi.fields": "字段与限制",
    "piUi.preview": "预览",
    "piUi.jsonExample": "JSON 示例",
    "piUi.error": "无法更新 Pi UI 设置：{message}",
    "piUi.promptOnlyNote": "这些开关只控制模型提示词，已有卡片仍会正常渲染。",
    "piUi.component.metrics.name": "指标",
    "piUi.component.metrics.description": "紧凑展示测量值和关键事实。",
    "piUi.component.comparison.name": "对比",
    "piUi.component.comparison.description": "并排比较二至四个选项。",
    "piUi.component.steps.name": "步骤",
    "piUi.component.steps.description": "展示有顺序的流程、计划或进度。",
    "piUi.component.tabs.name": "标签页",
    "piUi.component.tabs.description": "以支持键盘操作的标签页展示相关并列信息。",
    "piUi.component.accordion.name": "折叠面板",
    "piUi.component.accordion.description": "按需展开详细信息或分组结论。",
    "piUi.component.dataTable.name": "数据表格",
    "piUi.component.dataTable.description": "支持搜索、排序和分页的类型化记录表格。",
    "piUi.component.barChart.name": "柱状图",
    "piUi.component.barChart.description": "比较一个或多个系列的分类数值。",
    "piUi.component.lineChart.name": "折线图",
    "piUi.component.lineChart.description": "展示一个或多个系列随有序标签变化的趋势。",
    "piUi.component.areaChart.name": "面积图",
    "piUi.component.areaChart.description": "强调累计规模的数值趋势。",
    "piUi.component.donutChart.name": "环形图",
    "piUi.component.donutChart.description": "用少量分区展示整体构成。",
    "piUi.component.sparkline.name": "迷你趋势图",
    "piUi.component.sparkline.description": "紧凑展示单个数据系列的趋势。",
    "piUi.component.heatmap.name": "热力图",
    "piUi.component.heatmap.description": "按带标签的行列密集展示数值矩阵。",
    "piUi.component.status.name": "状态",
    "piUi.component.status.description": "以语义色调展示单个当前状态。",
    "piUi.component.keyValue.name": "键值信息",
    "piUi.component.keyValue.description": "平铺展示配置值或事实。",
    "piUi.component.progress.name": "进度",
    "piUi.component.progress.description": "展示已知任务的完成比例。",
    "piUi.component.checklist.name": "检查清单",
    "piUi.component.checklist.description": "带明确完成状态的简短任务列表。",
    "piUi.component.callout.name": "提示框",
    "piUi.component.callout.description": "突出展示简短说明和可选要点。",
    "auth.prompt": "登录后继续使用",
    "auth.password": "密码",
    "auth.logIn": "登录",
    "auth.loggingIn": "正在登录...",
    ...
    "visual.card": "可视化卡片",
    "visual.generating": "正在生成可视化卡片",
    "visual.showSource": "源代码",
    "visual.showCard": "卡片",
    "visual.error.incomplete": "这张可视化卡片未生成完整。",
    "visual.error.tooMany": "这条消息包含过多可视化卡片。",
    "visual.error.tooLarge": "这张可视化卡片内容过大。",
    "visual.error.tooDeep": "这张可视化卡片嵌套过深。",
    "visual.error.invalidJson": "这张可视化卡片包含无效 JSON。",
    "visual.error.invalidSchema": "这张可视化卡片不符合支持的格式。",
    "visual.error.render": "无法渲染这张可视化卡片。",
    "visual.status.complete": "已完成",
    "visual.status.current": "进行中",
    "visual.status.pending": "待处理",
    "visual.chart.category": "类别",
    "visual.chart.value": "数值",
    "visual.chart.point": "数据点",
    "visual.copyReadable": "复制可读文本",
    "visual.accordion.search": "搜索分组",
    "visual.accordion.expandAll": "全部展开",
    "visual.accordion.collapseAll": "全部折叠",
    "visual.accordion.noMatches": "没有匹配的分组。",
    "visual.accordion.status.neutral": "信息",
    "visual.accordion.status.success": "通过",
    "visual.accordion.status.warning": "警告",
    "visual.accordion.status.error": "错误",
    "visual.table.search": "搜索表格",
    "visual.table.filterBy": "按{column}筛选",
    "visual.table.allStatuses": "全部状态",
    "visual.table.copy": "复制表格",
    "visual.table.copied": "已复制",
    "visual.table.copyFailed": "无法复制表格。",
    "visual.table.downloadCsv": "下载 CSV",
    "visual.table.noMatches": "没有匹配的数据行。",
    "visual.table.range": "第 {start}-{end} 行，共 {total} 行",
    "visual.table.pagination": "表格分页",
    "visual.table.previous": "上一页",
    "visual.table.next": "下一页",
    "visual.table.page": "第 {page}/{pages} 页",
    "visual.table.status.neutral": "普通",
    "visual.table.status.success": "成功",
    "visual.table.status.warning": "警告",
    "visual.table.status.error": "错误",
    "i18n.zoomOut": "缩小",
    "i18n.zoomIn": "放大",
